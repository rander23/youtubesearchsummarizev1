...
if __name__ == "__main__":
    #Introduction
    print("FINDING & SUMMARIZING EDUCATIONAL YOUTUBE VIDEOS by Rander")
    ...
    # Display the video title, link, duration and summary
    print("\n")
    print("SUMMARY OF TOP YOUTUBE VIDEO SEARCH RESULTS")
    print("\n")
    for video_id, transcript_info in transcripts.items():
        print("----------------------------------------------------------------------------------")
        print(f"Video Title: {transcript_info['title']}")
        print(f"Video Link: {transcript_info['link']}")
        print(f"Duration: {transcript_info['duration']}")
        print(f"Summary: {transcript_info['summary']}\n")
